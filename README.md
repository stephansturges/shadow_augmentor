...
These are debug overlay bundles generated by the library itself. Each image shows:

- top-left: source image with cached polygons
- top-right: chosen edge and sampled shadow geometry
- bottom-left: final augmented output
- bottom-right: the shadow mask used for blending

<p align="center">
  <img src="assets/readme/single_object_preview.png" alt="Single-object shadow preview" width="48%" />
  <img src="assets/readme/two_object_preview.png" alt="Two-object shadow preview" width="48%" />
</p>

- Left: a single-object, bottom-biased shadow.
- Right: two selected objects, with at most one shadow per object in the same pass.
